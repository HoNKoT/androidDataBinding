...
import honkot.androiddatabinding.databinding.Sample4inflaterBinding;
...
//        });
    ...
    private class ListViewAdapter extends ArrayAdapter<UserObservable> {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            if (convertView == null) {
                Sample4inflaterBinding binding
                        = DataBindingUtil.inflate(LayoutInflater.from(getContext()), R.layout.sample4inflater, parent, false);
                convertView = binding.getRoot();
            }
            Sample4inflaterBinding binding = DataBindingUtil.getBinding(convertView);
